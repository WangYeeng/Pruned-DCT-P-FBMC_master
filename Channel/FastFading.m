classdef FastFading < handle
    ...
    methods
        function obj = FastFading(...
                ...
                PowerDelayProfile,...                              % Power delay profile, either string or vector: 'Flat', 'AWGN' or 'TDL-A_xxns','TDL-B_xxns','TDL-C_xxns' (with xx the RMS delay spread in ns, e.g. 'TDL-A_30ns'), or [1 0 0.2] (Self-defined power delay profile which depends on the sampling rate)
